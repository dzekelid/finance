...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/finance/master/_listings/pin-payments/apis.yaml
specificationVersion: "0.14"
apis: []
x-common:
- type: x-base
  url: http://api.pin.net.au
- type: x-blog
  url: https://pin.net.au/blog
- type: x-blog-rss
  url: https://pin.net.au/blog.atom
- type: x-crunchbase
  url: http://www.crunchbase.com/company/pin-payments
- type: x-developer
  url: https://pin.net.au/docs/guides/request-payments
- type: x-pricing
  url: https://pin.net.au/pricing
- type: x-twitter
  url: https://twitter.com/pin_payments
- type: x-website
